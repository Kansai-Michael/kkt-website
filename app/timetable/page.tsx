      ...
      <section className="bg-[#003087] text-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-white/80">
            Classes run Monday, Tuesday and Thursday evenings. Find a time that fits your family.
          </p>
        </div>
      </section>
          ...
          <div className="mb-12">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  {[
                    { program: "Little Lions (5–7 yrs)", mon: "—", tue: "4:15–5:00pm", thu: "4:15–5:00pm" },
                    { program: "Juniors (8–12 yrs)", mon: "5:15–6:15pm", tue: "5:00–5:45pm", thu: "5:00–5:45pm" },
                    { program: "Teens (13–17 yrs)", mon: "5:15–6:15pm", tue: "5:45–6:30pm", thu: "5:45–6:30pm" },
                    { program: "Adults (18+)", mon: "5:15–6:15pm", tue: "5:45–6:30pm", thu: "5:45–6:30pm" },
                  ].map((row, i) => (
